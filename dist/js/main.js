...
require('./modules/devices-scroll');

require('./modules/main-scroll-panels');

require('./modules/scripts-arrows');
},{"./modules/devices-filter":2,"./modules/devices-open-menu":3,"./modules/devices-popup":4,"./modules/devices-scroll":5,"./modules/main-scroll-panels":6,"./modules/scripts-arrows":7}],2:[function(require,module,exports){
